...
<div>
	<ul>
		...
		<li><a href="http://182.92.99.6/ecmobile/?url=/article&article_id=20" target="_blank">内容查看页面链接   /article&article_id=10</a></li>
		<li><a href="http://182.92.99.6/ecmobile/?url=/huodong" target="_blank">活动页面   /huodong</a></li>
	</ul>
</div>
<?php
} elseif($ac=='bonus') {
